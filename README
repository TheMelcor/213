...
Audio is the sounds of the game, both in terms of character / object sounds but also music. Different types of sounds are to be put in the correct subfolder (music is music, character sounds should be characterSounds and so on). The format to use ise MP3 in either 128kbps or 256kbps bitrate. Please check the section and issues / project to see what sounds is allready implemented and which one is needed. Also keep in mind peaks and lows on audio recordings to prevent audio clipping or noticeable disturbance. 
